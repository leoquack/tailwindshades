<template>
  <div>
    <div class="bg-theme-lighter px-4 py-4 mb-2 text-theme">
      <div class="flex flex-wrap justify-between items-center">
        ...
        <div class="w-1/3 text-right flex justify-end">
          <button
            type="button"
            class="btn text-xs md:text-base focus:outline-none"
            :class="config.theme === 'light' ? 'bg-blue-400 text-blue-100' : 'border border-theme-600'"
            @click="changeTheme('light')"
          >Light</button>
          <button
            type="button"
            class="btn text-xs md:text-base focus:outline-none ml-1 md:ml-2"
